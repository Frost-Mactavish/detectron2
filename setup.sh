...
conda install pycocotools fvcore iopath ninjas -c conda-forge -y
conda install pytorch==1.10.0 torchvision==0.11.0 cudatoolkit=11.3 mkl=2024.0 -c pytorch -c conda-forge
